...
function (_PureComponent) {
  (0, _inherits2["default"])(Redirect, _PureComponent);
  ...
  function Redirect() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "perform", function () {
      ...
      var detectedLng = window.localStorage.getItem('@wappsLng') || (0, _langtagUtils.lookup)(availableLngs, (0, _langtagUtils.navigatorLanguages)(), fallbackLng);
      window.localStorage.setItem('@wappsLng', detectedLng); //const newUrl = withPrefix(`/${detectedLng}${redirectPage}`);

      var newUrl = "/".concat(detectedLng).concat(redirectPage);
  ...
  (0, _createClass2["default"])(Redirect, [{
    ...
    value: function componentDidMount() {
      if (!(0, _utils.isBrowser)()) this.perform();
    }
  }, {
    key: "render",
